...
module.exports = (test, options, index) =>
	test('move a virtual resource (overwrite test)', (isValid, server) => {
		...
		server.addResourceTree([new webdav.VirtualFile(fileName), new webdav.VirtualFile(fileNameDest)], (e) =>
			_(e, () => {
		...
		server.addResourceTree([new webdav.VirtualFile(fileName2), new webdav.VirtualFile(fileNameDest2)], (e) =>
			_(e, () => {
