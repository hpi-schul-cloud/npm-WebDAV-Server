...
export abstract class FileSystem implements ISerializableFileSystem
{
    ...
    addSubTree(ctx : RequestContext, _rootPath : Path | SubTree | ResourceType | SimpleCallback | string | Buffer, _tree : SubTree | ResourceType | SimpleCallback | string | Buffer, _callback ?: SimpleCallback) : void
    {
